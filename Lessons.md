...
### Как подготовиться к рабботе в мастерской
...
- Надо изучить данное пособие, в нем мало лишнего, информация дается популярно.

### Подготовка к работе
Для работы и для обучения нам понадобятся программные средства. Для новичков рекомендуется VisualStudio 2019 с достаточно свежими обновлениями. 
